...
- The live Horizon theme includes `shopify-theme-overrides/ct-product-consolidation.liquid` before `</body>`. It shows each photograph once in storefront grids and adds Fine Art, Framed, and Canvas choices to the product page while preserving separate Gelato fulfillment products underneath.
